					...
					<div class="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
						...
						<div class="hidden sm:ml-6 sm:block">
							<div class="flex ml-8 space-x-4">
								...
								<a href="./drive.php" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-900">Espace personnel</a>
			...
			<section id="drive" class="">
				...
				<div class="flex justify-between">
					<div class="md:flex md:space-x-4">
						<h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Espace public</h2>
						<p class="text-sm text-gray-500 md:relative -bottom-3">Toutes les vidéos enregistrées par la communauté</p>
					</div>
				</div>
				...
				<div class="grid grid-cols-1 mt-8 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
					...
					<?php
						$sql = "SELECT * FROM VIDEOS WHERE bpublic = true ORDER BY id DESC;";
